    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="text-center">
                <span style="font-size:25px;font-color:black"><strong>Total Payment for the day</strong></span>
              </div>
          ...
          <br>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="box">
                        <div class="text-left">
                            <a href="/deliver_history" class="btn btn-secondary"><i class="fa fa-step-backward" aria-hidden="true"></i>&nbsp; Back</a>
                        </div>
   ...
   {{ csrf_field() }}
        ...
        <div class="input-group">
            <div class="form-outline">
                <input type="date" name="query" id="form1"  placeholder="search by date..." style="height:35px" class="form-control"/>
                    ...
                    <tbody>
                        ...
                        @php $total = "0" @endphp
                                    @foreach($data as $value)
                                            ...
                                            <tr>
                                            <td style="height:40px"><div class="text-center">{{$value->id}}</div></td>
                                            <td style="height:40px"><div class="text-center">{{$value->order_id}}</div></td>
                                            <td style="height:40px"><div class="text-center">{{$value->deleted_at}}</div></td>
                                            <td style="height:40px"><div class="text-center">{{$value->city}}</div></td>
                                            <td id="total_price" style="width:30px"><div class="text-center">{{$value->total_price}}</div></td>
                                            <td>
                                            <div class="text-center">                     
                      ...
                      <tr>
                          ...
                          <td></td>
                          <td></td>
                          <td style="height:40px"><b>Total payment for the day ::
