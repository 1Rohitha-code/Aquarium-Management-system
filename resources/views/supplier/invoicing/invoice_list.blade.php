              ...
              <table id="rfq_list" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td>
                       <form action="/update_payment_status/{{$val->sup_id}}/{{$val->quot_id}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="input-group">
                         <select class="form-select" id="invoice_payment_status" name="invoice_payment_status" style="width:155px;height:40px">
                           <option value="done" {{($val->invoice_payment_status === 'pending') ? 'Selected' : ''}}>Pending</option>
                           <option value="payment done" {{($val->invoice_payment_status === 'payment done') ? 'Selected' : ''}}>Payment done</option>
                        </select>
