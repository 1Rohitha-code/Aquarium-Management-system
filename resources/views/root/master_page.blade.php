...
<!----------display some buttons according to user type---------->

                    <!-------------------to avoid giving error of undefined variable of $get_order_count variable-------------------------->
                    <?php 
                    $logged_in_cus_mail= Auth::user()->email;
                    $get_order_count = DB::table('delivery__infos')
                    ...
                    ->count();
                    ?>
                    <!-----------------to get the order count infront of the button-------------------------------------->
                        <?php 
                            if((Auth::user()->role_as)=='deliver'){
                                
                               echo '<a href="#" class="btn btn-primary">Inbox</a>';

                            }elseif((Auth::user()->role_as)==NULL){ 
                                
                              echo  '<div class="text-right">
                            <a href="/my_orders" class="btn btn-primary " >Check my orders</a>';
                         echo '</div><span class="position-absolute top-0  translate-middle badge rounded-pill bg-danger">&nbsp;'.$get_order_count.'&nbsp;</span>';
                            
                        }elseif((Auth::user()->role_as)=='supplier'){
                                echo  '<div class="text-right">
                                <a href="##" class="btn btn-primary " >Supplier button</a>
                             </div>';
                            }else{
                                echo  '<div class="text-right">
                                <a href="/my_orders" class="btn btn-primary " >Constructor button</a>
                             </div>';
                            }
  ...
  <!----------display some buttons according to user type---------->                     
						...
						<a class="nav-icon" href="{{url('/cart')}}" >
                            ...
                            if ((Auth::user()->role_as)==null) {
                                    ...
                                    <span class="clearfix" style="font-size:13px">
                                        Cart
                ...
                <img src="{{url('Landingpage/images/5.jpg')}}" class="avatar img-fluid rounded mr-1" alt="fish name" />  <span class="text-dark">{{ Auth::user()->name }}</span>
              </a>
				...
				<!-- <div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-left">
							<p class="mb-0">
								<a href="index.html" class="text-muted"><strong>Bright Aqua</strong></a> &copy;
							</p>
						</div>
