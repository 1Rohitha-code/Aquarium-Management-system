    ...
    <div class="col-12 col-xl-12">
        <div class="card">
            ...
            <div class="card-header text-center">
               <span style="font-size:25px;font-weight:bold">Request for Quotations (RFQ)</span>
            </div>
            ...
            <div class="card-body">
              ...
              <table id="rfq_list" class="table table-bordered table-striped">
                ...
                <th style="width:30px">No</th>
                    ...
                    <th style="width:50px">Delivered date</th>    
                    <th style="width:50px">Response expected date</th> 
                    <th style="width:50px">individual supplier activity on RFQ</th> 
                    <th style="width:50px">Action</th>  
                </tr>
                </thead>
                <tbody>
             @php $i=1 ; @endphp @foreach($list_of_rfq_details as $data)
             <tr>
                    <td>
                        <?php echo $i;?>  
                       </td>
                     ...
                     {{$data->id}}
                       ...
                       <div class="text-center">
                         <a href="/list_of_suppliers_with_rfq/{{$data->id}}" class="btn btn-primary detail-btn " ><i class="fa fa-eye" aria-hidden="true"></i></a>
                       </div> 
                       </td>
                       </td>
