    ...
    <div class="col-12 col-xl-12">
        <div class="card">
            ...
            <div class="text-right">
               <span style="font-size:16px;color:black;font-weight:bold"> No. of New Suppliers : <?php echo count($new_sup_count); ?> </span>
            </div>

            <div class="card-header text-center">
                <span  style="font-size:24px;color:black;font-weight:bolder">Information to be included to the RFQ Letter</span>
                <div class="text-right">
            
            </div>
            </div>
            <div class="card-body">
            <form method="post" action="/store_required_info" class="rfq-qty-form" id="rfq-qty-form" enctype="multipart/form-data">
                            @csrf
                                                <div class="pull-left">
                                                   Response expected date :
                                                   <input type="date" id="responsive_date" class="form-control selected_date" style="width:200px" name="response_expected_date">
                                                    </div>
                                                    <br>
                                                    <br><br>
                                                    <br>
