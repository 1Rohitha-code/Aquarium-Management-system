...
@section('content')
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <!--DELETE MODAL-->
  <!-- Modal -->
        <div class="modal fade" id="decor_delete_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form id="delete_decor_modal_form" method="POST">
                    {{csrf_field()}}
                    {{method_field('DELETE')}}
            ...
            <div class="card-body">
                <div class="container">
                    ...
                    <th>Action</th>
                            ...
                            <tbody>
                                @foreach($decorations_list as $value)
                                <tr>
                                    ...
                                    <td>
                                    <a href="/see_more_decor/{{$value->product_id}}" class="btn btn-info "><i data-feather="eye"></i></a>
                                    <a href="/edit_decoration_data/{{$value->product_id}}" class="btn btn-primary "><i data-feather="edit"></i></a>
