...
<div class="col-md-12">
    <div class="card" style="font-size:16px;   border: 2px solid rgb(54, 102, 27);">
        <div class="card-header">
           ...
           <h2><b>Add New Fishfood Product</b></h2>
        </div>
    </div>
        <div class="card-body">
            ...
            <form  method="POST" action="/save_fishfood_form" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="row">
                    ...
                    <label class="form-label" for="inputEmail4" style="font-size:16px">Weight</label>
                        <input type="text" name="weight" class="form-control my-colorpicker1" placeholder="Weight" >
                    </div>
                    <div class="mb-3 col-md-6">
                    <label class="form-label" for="inputPassword4" style="font-size:16px">Available as</label>
                        <select class="form-control my-colorpicker1" name="available_as" id="available_as">
                            ...
                            <option>Sinking sticks</option>
                            <option>Powder</option>
                            <option>Sinking Wafers</option>
                ...
                <div class="row">
                    <div class="mb-3 col-md-12">
                        ...
                        <textarea class="form-control my-colorpicker1" name="product_details" id="product_details" rows="5" placeholder="Product details"></textarea>
                    </div>
                    <div class="mb-3 col-md-12">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Ingredients</label>
                        <textarea class="form-control my-colorpicker1" name="ingredients" id="ingredients" rows="4" placeholder="Ingredients"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-12">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Feeding suggestions</label>
                        <textarea class="form-control my-colorpicker1" name="feeding_suggestions" id="feeding_suggestions" rows="4" placeholder="Feeding suggestions"></textarea>
                    </div>
                    <div class="mb-3 col-md-6">
