    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="text-center">
                <span style="font-size:25px;font-color:black"><strong>My Orders</strong></span>
              </div>
          ...
          <br>
            <div class="col">
                <div class="form-group">
                   ...
                   <a href="/completed_orders" class="btn btn-success">Completed Orders</a>
                    </div>
            </div>
            </div>
                ...
                <table id="myorder_list" class="display table-striped table-bordered ">
                    <thead>
                        <tr>
                            ...
                            <th style="width:80px">To be recieved at</th>
                    ...
                    @else
                    <div class="text-center">
                            <span style="font-size:25px;color:red">You have not requested for any orders yet.<a href="/normal_user" class="btn btn-info">Buy an Ornamental Fish</a></span>
                    </div>
                    @endif 
